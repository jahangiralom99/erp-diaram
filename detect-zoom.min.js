(function (e, t, n) {
  ...
  var r = function () {
    var t = Math.abs(window.orientation) == 90 ? screen.height : screen.width;
  ...
  var o = function () {
    ...
    var r = 1e3 / n.clientHeight;
    r = Math.round(r * 100) / 100;
    document.body.removeChild(i);
    return { zoom: r, devicePxPerCssPx: r * e() };
  };
  var d = function () {
    var e = s("min--moz-device-pixel-ratio", "", 0, 10, 20, 1e-4);
    e = Math.round(e * 100) / 100;
    return { zoom: e, devicePxPerCssPx: e };
  };
  var a = function () {
  ...
  var s = function (e, t, n, i, r, o) {
    ...
    if (window.matchMedia) {
      ...
      d = function (e) {
        ...
        var t = getComputedStyle(s, null).textDecoration == "underline";
  ...
  var c = (function () {
    ...
    if (!isNaN(screen.logicalXDPI) && !isNaN(screen.systemXDPI)) {
      ...
      typeof document.body.style.webkitTextSizeAdjust === "string"
    ) {
      e = r;
